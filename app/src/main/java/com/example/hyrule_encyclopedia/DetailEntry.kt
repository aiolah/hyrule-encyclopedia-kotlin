...
fun DetailEntry(id: Int, category: String, viewModel: MainViewModel, backStack: NavBackStack<NavKey>) {
    if(category == "creatures")
    {
        ...
        DetailComposable(creature.name, creature.image, creature.description, creature.category, creature.common_locations, creature.drops, "")
    }
    else if(category == "monsters")
    {
        ...
        DetailComposable(monster.name, monster.image, monster.description, monster.category, monster.common_locations, monster.drops, "")
    }
    else if(category == "materials")
    {
        ...
        DetailComposable(material.name, material.image, material.description, material.category, material.common_locations, null, material.cooking_effect)
    }
    else if(category == "equipment")
    {
        ...
        DetailComposable(equipment.name, equipment.image, equipment.description, equipment.category, equipment.common_locations, null, "")
    }
    else if(category == "treasure")
    {
        ...
        DetailComposable(treasure.name, treasure.image, treasure.description, treasure.category, treasure.common_locations, treasure.drops, "")
    }
}

@Composable
fun DetailComposable(name: String, image: String, description : String, category: String, common_locations: MutableList<String>?, drops: MutableList<String>?, cooking_effect: String) {
    Column(
        modifier = Modifier
